...
# แก้ไขเฉพาะหน้า
#####################################
$arrPathGraphCPU['61.19.255.74'][LINK]="http://61.19.255.74/munin/localhost/localhost/cpu.html";
$arrPathGraphCPU['61.19.255.74'][SRC]="http://61.19.255.74/munin/localhost/localhost/cpu-day.png";
$arrPathGraphCPU['61.19.255.75'][LINK]="http://61.19.255.75/munin/master/master/cpu.html";
$arrPathGraphCPU['61.19.255.75'][SRC]="http://61.19.255.75/munin/master/master/cpu-day.png";

$arrPathGraphMEM['61.19.255.74'][LINK]="http://61.19.255.74/munin/localhost/localhost/memory.html";
$arrPathGraphMEM['61.19.255.74'][SRC]="http://61.19.255.74/munin/localhost/localhost/memory-day.png";
$arrPathGraphMEM['61.19.255.75'][LINK]="http://61.19.255.75/munin/master/master/memory.html";
$arrPathGraphMEM['61.19.255.75'][SRC]="http://61.19.255.75/munin/master/master/memory-day.png";
#####################################
$n=1; 
  ...
  // +++++++++++++++++++++++++++++++++++
  if($hw=="cpu"){
		if($arrPathGraphCPU[$key][LINK]!=""){
				$url_link=$arrPathGraphCPU[$key][LINK];
				$url_src =$arrPathGraphCPU[$key][SRC];
		}else{
  ...
  //$url_src = "http://".$key."/cacti/graph_image.php?action=view&local_graph_id=".$values[gid_mem]."&rra_id=0&graph_height=80&graph_width=300&graph_nolegend=true";
  		if($arrPathGraphMEM[$key][LINK]!=""){
				$url_link=$arrPathGraphMEM[$key][LINK];
				$url_src =$arrPathGraphMEM[$key][SRC];
		}else{
